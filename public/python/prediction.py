...
plt.savefig('/opt/bitnami/apps/stockmarketaws/public/images/ClosingPrice.png')
A.plot(x='Date', y='Volume')
plt.savefig('/opt/bitnami/apps/stockmarketaws/public/images/Volume.png')
MA_day = [10,20,50,100]
...
A[['Closing Price','MA for 10 days','MA for 20 days','MA for 50 days','MA for 100 days']].plot(subplots=False,figsize=(10,4))
plt.savefig('/opt/bitnami/apps/stockmarketaws/public/images/Moving-Average.png')
